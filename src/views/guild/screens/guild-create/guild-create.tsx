...
export const GuildCreate = observer(() => {
  ...
  return (
    <Screen preset='scrollStack'>
      ...
      <Text
        preset='bold'
        // tx='guild.guildBeaconAndServiceArea'
        text='Guild Beacon'
        style={DESCRIP_SPACING}
      />
      <Text
        preset='description'
        // tx='guild.guildBeaconAndServiceArea'
        text='This will be visible globally. If you want it in a different location, move to another area and log in again to the app.'
        // style={DESCRIP_SPACING}
