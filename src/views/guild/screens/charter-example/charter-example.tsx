...
export const CharterExample: React.FC<{}> = () => {
  ...
  return (
    <Screen preset='scrollStack'>
      <Text preset='bold' text='Introduction' style={{ marginTop: 25 }} />
      <Text
        preset='description'
        text='Here is the charter from our first guild, Arcade City Austin. You can use this as a template for your own charter. '
      />

      <Text
        preset='description'
        text="Arcade City Austin has provided reliable citywide service since May 2016, organizing primarily through Facebook. Their charter reflects more than three years of lessons learned operating the world's first self-governing rideshare network. Lots to learn from!"
      />

      <Text
        preset='description'
        text='Note that some provisions are specific to organizing requests on Facebook and will need to be modified for use in our mobile app.'
      />
