...
export const AllRequestDetails: React.FC<{}> = observer(() => {
  ...
  const clickedSend = () => {
    ...
    if (parseFloat(authStore.distance(coords)) > 30) {
      Alert.alert('The pickup address is too far from your current location.')
      return
    }
  ...
  return (
    ...
    >
      <View>
        ...
        <View style={SPACED_ROW}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Alert.alert(
                'In an upcoming version you will have the option to send requests directly to a specific driver or guild.'
              )
            }
          >
            <View style={{ flexDirection: 'row' }}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Alert.alert(
                'You will be able to schedule future rides in an upcoming version. For now just work out the details with your driver directly.'
              )
            }
          >
            <View style={{ flexDirection: 'row' }}>
        ...
        <View style={SPACED_ROW}>
          ...
          <TouchableOpacity
            style={{ flex: 1, flexDirection: 'row', ...MARGINTOP }}
            onPress={() =>
              Alert.alert('For now you will negotiate fare with your driver.')
            }
          >
            <View style={ICON_CONTAINER}>
              <Icon name='dollar' />
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Alert.alert(
                'In-app card payments will be supported in an upcoming version. For now you can negotiate payment options with your driver.'
              )
            }
          >
            <View style={{ flexDirection: 'row' }}>
        ...
        >
          ...
          <View style={PADDINGLEFT}>
            ...
            <Text
              preset='bold'
              text={
                details && details.length > 0 ? details : 'Tap to add details'
              }
            />
          </View>
        </TouchableOpacity>
      ...
      <Button
        text={submitted ? 'Sending...' : 'Send Request to Drivers'}
