...
export const SetUsername: React.FC<{}> = observer(() => {
  ...
  return (
    <Screen preset='fixedStack'>
      <Text preset='title' text='Set username' style={{ paddingTop: 40 }} />
      <Text
        preset='description'
        text='Enter the username for your public profile'
      />
      <TextField
        value={field}
        autoFocus={true}
      ...
      />
      <Button onPress={handleSubmit(submitUsername)} text='Submit' />
    </Screen>
  )
})
