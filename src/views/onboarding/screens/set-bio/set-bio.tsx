...
export const SetBio: React.FC<{}> = observer(() => {
  ...
  return (
    <Screen preset='fixedStack'>
      <Text preset='title' text='Set bio' style={{ paddingTop: 40 }} />
      <Text preset='description' text='Enter the bio for your public profile' />
      <TextField
        multiline
        value={field}
        autoFocus={true}
      ...
      />
      <Button onPress={handleSubmit(submitBio)} text='Submit' />
    </Screen>
  )
})
